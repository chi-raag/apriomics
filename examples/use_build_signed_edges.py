...
try:
    ...
    print(
        f"Error: Could not import the required module. Ensure the package is installed or the path is correct. {e}"
    )
    sys.exit(1)
...
try:
    ...
    print(
        "Please ensure the 'apriomics' package is installed (e.g., 'pip install -e .')"
    )
...
def main():
    ...
    if not edges:
        print(
            "No edges were generated. This might be due to errors fetching/parsing reactions."
        )
