...
from apriomics.visualization import (
...
def create_example_signed_edges():
    ...
    try:
        ...
        print(
            f"Generated {len(signed_edges)} signed edges from {len(example_reactions)} reactions"
        )
        return signed_edges
        ...
        same_side_pairs = [
            ...
            (
                "C00092",
                "C00031",
            ),  # G6P and Glucose (substrate-product but also cofactor)
        ]
...
def create_example_bayesian_scores():
    ...
    example_metabolites = [
        (
            ...
            "large",
            "high",
            "Primary substrate elevated in diabetes",
        ),
        (
            "Lactate",
            "increase",
            "moderate",
            "high",
            "Elevated due to anaerobic metabolism",
        ),
        ...
        (
            ...
            "moderate",
            "low",
            "Variable depending on metabolic state",
        ),
    ...
    for metabolite, direction, magnitude, confidence, rationale in example_metabolites:
        ...
        direction_mapping = {"increase": 1, "decrease": -1, "minimal": 0, "unclear": 0}
        ...
        confidence_mapping = {"high": 0.8, "moderate": 1.0, "low": 1.4}
...
def main():
    ...
    try:
        analyze_priors(
            signed_edges, bayesian_scores, output_dir="output/visualization_report"
        )
